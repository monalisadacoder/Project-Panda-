...
<head>
    ...
    <link rel="stylesheet" href="weekly.js">
    ...
    <nav id="nav1" class="navbar navbar-light bg-light">
        <div class="container-fluid">
          <a class="navbar-brand">
            <img class="primary-logo" alt="action-img" src="TotalEnergies-Emblem.png">
        </a>
        <div class="navibar">
      ...
      <div id="mySidenav" class="sidenav">
        <li id="profileIcon"><h5>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img class="icon1" alt="users-icon" src="bxs_user-circle.png"></h5></li>
        <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
        <a href="profile.html" id="mail">****@gmail.com</a>
      ...
      function openNav() {
        ...
        document.getElementById("mySidenav").style.borderRadius ="10px";
      ...
      <script>
        ...
        <!-- <button class="save">
          <a href="report.html" style="text-decoration:none ;">save</a>
        </button> -->
        <button type="button" id="save" class="btn btn-outline-danger">
          <a href="report.html" style="text-decoration:none ; color: rgb(241, 11, 11);">Download</a></button>
